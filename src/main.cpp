...
void shared_ptr_test(void) {
	...
	if (xPtr) { // empty pointer
		...
		kcw::shared_ptr<Xxx> yPtr(new Xxx(1024));
		// Same as :
		//shared_ptr<Xxx> yPtr;
		...
		std::vector<kcw::shared_ptr<Xxx>> PtrVec;
	...
	{
		std::vector<kcw::shared_ptr<Xxx>> PtrList;
...
void unique_ptr_test(void) {
	...
	if (!xPtr) { // empty pointer
		...
		kcw::unique_ptr<Xxx> yPtr(new Xxx(1024));
		// Same as :
		//unique_ptr<Xxx> yPtr;
		//yPtr.reset(new Xxx(1024));
		...
		std::vector<kcw::unique_ptr<Xxx> > PtrVec;
		PtrVec.push_back(xPtr);
		std::cout << "xPtr=" << xPtr.get() << std::endl;
	...
	{
		std::vector<kcw::unique_ptr<Xxx> > PtrList;
